...
export default function PartnerInvitationLogin() {
    ...
    try {
      ...
      for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
          ...
          const edgeFunctionPromise = supabase.functions.invoke('validate-partner-invitation', {
            body: {
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                  ...
                  <Box>
                    <Typography variant="body1" sx={{ fontWeight: 500 }}>
                      {invitation?.partnerCompany?.name}
                    </Typography>
