...
// QSC項目ラベル（generate-analytics-ai-textと統一）
...
【QSC項目キー一覧】
Quality: q1=味・品質, q2=新鮮さ, q3=量, q4=メニューの種類, q5=盛り付け・見た目, q6=温度, q7=季節メニュー, q8=特別メニュー, q9=価格に対する品質, q10=全体的な満足度
Service: s1=スタッフの挨拶, s2=注文対応, s3=料理提供スピード, s4=気配り・声かけ, s5=メニュー説明, s6=クレーム対応, s7=スタッフの笑顔, s8=子供への対応, s9=会計対応, s10=全体的な接客
Cleanliness: c1=店内の清潔さ, c2=テーブル・席の清潔さ, c3=トイレの清潔さ, c4=食器の清潔さ, c5=スタッフの身だしなみ, c6=キッチンの清潔さ, c7=外観の清潔さ, c8=換気・空調, c9=ゴミ・汚れ, c10=全体的な衛生管理
