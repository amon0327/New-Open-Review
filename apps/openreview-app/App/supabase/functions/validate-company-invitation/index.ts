...
serve(async (req) => {
  ...
  try {
    console.log('=== validate-company-invitation Edge Function開始 ===')
    ...
    console.log('Querying company_user_invitations with token:', invitationToken)
    ...
    console.error('=== validate-company-invitation Edge Function エラー ===')
