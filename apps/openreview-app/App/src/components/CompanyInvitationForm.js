...
export default function CompanyInvitationForm({
  companyId,
  companyName,
  onClose,
  onInvitationSent
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('create-company-invitation', {
        body: {
          companyId: companyId,
        ...
        {success ? (
          ...
          >
            <Box sx={{ py: 2 }}>
              ...
              >
                {invitationData?.url || `https://app.openreview.jp/company-invitation/${invitationData?.token}`}
              </Box>
              ...
              <Button
                ...
                onClick={() => {
                  const url = invitationData?.url || `https://app.openreview.jp/company-invitation/${invitationData?.token}`;
